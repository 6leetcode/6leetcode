...
<pre>
<strong>Input: </strong>n = <span id="example-input-1-1">5</span>
...
<pre>
<strong>Input: </strong>n = <span id="example-input-2-1">7</span>
...
<pre>
<strong>Input: </strong>n = <span id="example-input-3-1">10</span>
