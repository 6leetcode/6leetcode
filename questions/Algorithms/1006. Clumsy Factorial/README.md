...
<pre>
<strong>Input: </strong>n = <span id="example-input-1-1">10
...
<ol>
	...
	<li><code>-2<sup>31</sup> &lt;= answer &lt;= 2<sup>31</sup> - 1</code>&nbsp; (The answer is guaranteed to fit within a 32-bit integer.)</li>
</ol>
