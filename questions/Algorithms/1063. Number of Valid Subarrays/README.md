...
<p>Given an array <code>nums</code> of integers, return the number of <strong>non-empty continuous subarrays</strong> that satisfy the following condition:</p>
...
<pre>
<strong>Input: </strong>nums = <span id="example-input-1-1">[1,4,2,5,3]</span>
...
<pre>
<strong>Input: </strong>nums = <span id="example-input-2-1">[3,2,1]</span>
...
<pre>
<strong>Input: </strong>nums = <span id="example-input-3-1">[2,2,2]</span>
...
<ol>
	...
	<li><code>0 &lt;= nums[i] &lt;= 100000</code></li>
</ol>
